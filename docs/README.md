...
|---|---|
| [erste-schritte.md](erste-schritte.md) | Schritt-für-Schritt-Anleitung für den ersten Lauf (Deutsch) |
...
| [operators.md](operators.md) | The four geomorphological operators, as we formulated them |

The project README carries the quick start, the milestone status and the
